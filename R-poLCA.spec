...
%setup -q -n poLCA
pushd ..
cp -a poLCA buildavx2
popd
pushd ..
cp -a poLCA buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737153053
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/poLCA/libs/poLCA.so
/V4/usr/lib64/R/library/poLCA/libs/poLCA.so
